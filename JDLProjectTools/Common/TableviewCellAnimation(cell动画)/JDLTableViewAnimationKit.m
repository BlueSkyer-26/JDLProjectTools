...
#define JDL_SCREEN_WIDTH [[UIScreen mainScreen] bounds].size.width
#define JDL_SCREEN_HEIGHT [[UIScreen mainScreen] bounds].size.height

@implementation JDLTableViewAnimationKit
...
+ (void)moveAnimationWithTableView:(UITableView *)tableView {
    ...
    for (int i = 0; i < cells.count; i++) {
        ...
        cell.transform = CGAffineTransformMakeTranslation(-JDL_SCREEN_WIDTH, 0);
...
+ (void)fallAnimationWithTableView:(UITableView *)tableView {
    ...
    for (int i = 0; i < cells.count; i++) {
        UITableViewCell *cell = [tableView.visibleCells objectAtIndex:i];
        cell.transform = CGAffineTransformMakeTranslation(0, - JDL_SCREEN_HEIGHT);
...
+ (void)springListAnimationWithTableView:(UITableView *)tableView {
    ...
    for (int i = 0; i < cells.count; i++) {
        ...
        cell.layer.transform = CATransform3DMakeTranslation(0, -JDL_SCREEN_HEIGHT, 20);
